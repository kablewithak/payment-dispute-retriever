...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--query",
        required=True,
        help="Natural language dispute query.",
    )
    parser.add_argument(
        "--payment-rail",
        default=None,
        help="Optional payment rail filter.",
    )
    parser.add_argument(
        "--scheme",
        default=None,
        help="Optional scheme filter.",
    )
    parser.add_argument(
        "--region",
        default=None,
    ...
    parser.add_argument(
        "--reason-code",
        default=None,
        help="Optional reason code filter.",
    )
    parser.add_argument(
        "--limit",
        type=int,
